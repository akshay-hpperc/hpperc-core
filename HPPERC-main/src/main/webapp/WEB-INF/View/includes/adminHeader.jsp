...
<html lang="en">
  <head>
    ...
    <link href="<%=request.getContextPath()%>/resources/lib/datatables.net-dt/css/jquery.dataTables.min.css" rel="stylesheet">
    <link href="<%=request.getContextPath()%>/resources/lib/datatables.net-responsive-dt/css/responsive.dataTables.min.css" rel="stylesheet">
 	<link href="<%=request.getContextPath()%>/resources/lib/select2/css/select2.min.css" rel="stylesheet">
    <!-- DashForge CSS -->
      ...
      <div class="navbar-right">
        ...
        <div class="dropdown dropdown-profile">
          ...
          <div class="dropdown-menu dropdown-menu-right tx-13">
            ...
            <a href="<%=request.getContextPath()%>/logout" class="dropdown-item"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-out"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>Sign Out</a>
          </div><!-- dropdown-menu -->
        </div><!-- dropdown -->
    ...
    <div id="sidebarMenu" class="sidebar sidebar-fixed sidebar-components">
      ...
      <div class="sidebar-body">
        <ul class="sidebar-nav">
          ...
          <li class="nav-item"><a href="hpAdminList" class="nav-link"><i data-feather="layout"></i> HP Admin Creation</a></li>
          <li class="nav-item"><a href="#" class="nav-link"><i data-feather="grid"></i>HPPERC Dashboard</a></li>
          <li class="nav-item"><a href="#" class="nav-link"><i data-feather="grid"></i>University Dashboard</a></li>
        </ul>
      </div><!-- sidebar-body -->
    </div><!-- sidebar -->
