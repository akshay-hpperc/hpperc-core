    ...
    <div id="sidebarMenu" class="sidebar sidebar-fixed sidebar-components">
      ...
      <div class="sidebar-body">
        <ul class="sidebar-nav">
          ...
          <li class="nav-item"><a href="hpAdminList" class="nav-link"><i data-feather="layout"></i> Basic Details</a></li>
          <li class="nav-item"><a href="#" class="nav-link"><i data-feather="grid"></i>Course Details</a></li>
          <li class="nav-item"><a href="#" class="nav-link"><i data-feather="grid"></i>Fee Structure</a></li> <br>
          <li class="nav-item"><a href="#" class="nav-link"><i data-feather="grid"></i>Inspection</a></li>
          <li class="nav-item"><a href="#" class="nav-link"><i data-feather="grid"></i>Finance Details</a></li>
          <li class="nav-item"><a href="#" class="nav-link"><i data-feather="grid"></i>Infrastructure</a></li> <br>
          <li class="nav-item"><a href="#" class="nav-link"><i data-feather="grid"></i>Facilities</a></li>
          <li class="nav-item"><a href="#" class="nav-link"><i data-feather="grid"></i>Research and Project</a></li>
          <li class="nav-item"><a href="#" class="nav-link"><i data-feather="grid"></i>Examination</a></li> <br>
          <li class="nav-item"><a href="#" class="nav-link"><i data-feather="grid"></i>Meeting</a></li>
          <li class="nav-item"><a href="#" class="nav-link"><i data-feather="grid"></i>Faculty Details</a></li>
          <li class="nav-item"><a href="#" class="nav-link"><i data-feather="grid"></i>HPPERC Communication</a></li> <br>
          ...
          <li class="nav-item"><a href="#" class="nav-link"><i data-feather="grid"></i>Grievance</a></li> <br>
          <li class="nav-item"><a href="#" class="nav-link"><i data-feather="grid"></i>Library</a></li>
          <li class="nav-item"><a href="#" class="nav-link"><i data-feather="grid"></i>Student</a></li>
        </ul>
      </div><!-- sidebar-body -->
    </div><!-- sidebar -->
